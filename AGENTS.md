...
- Eccezione esplicitamente voluta: segnare una nota della lista della spesa come acquistata (`shopping.tsx`) e l'azione inversa, rimetterla in lista dagli Acquistati (`shopping-purchased.tsx`), NON chiedono conferma. Sono un'azione a due vie, simmetrica e a costo zero da annullare in entrambe le direzioni (un secondo tocco basta), quindi il popup sarebbe solo attrito senza reale protezione.
