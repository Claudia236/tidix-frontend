...
const ENTRIES: Record<string, EntryTriple> = {
  ...
  // categories
  'category.LATTICINI.label': { it: 'Latticini', en: 'Dairy', es: 'Lácteos' },
  'category.LATTICINI.short': { it: 'Latticini', en: 'Dairy', es: 'Lácteos' },
  'category.CARNE.label': { it: 'Carne e pesce', en: 'Meat and fish', es: 'Carne y pescado' },
  'category.CARNE.short': { it: 'Carne/Pesce', en: 'Meat/Fish', es: 'Carne/Pescado' },
  ...
  'category.CEREALI.label': { it: 'Pasta e cereali', en: 'Pasta and grains', es: 'Pasta y cereales' },
  'category.CEREALI.short': { it: 'Pasta/Cereali', en: 'Pasta/Grains', es: 'Pasta/Cereales' },
  'category.CONSERVE.label': { it: 'Conserve e legumi', en: 'Canned goods and legumes', es: 'Conservas y legumbres' },
  'category.CONSERVE.short': { it: 'Conserve/Legumi', en: 'Canned/Legumes', es: 'Conservas/Legumbres' },
  ...
  'category.PIATTI_PRONTI.label': { it: 'Avanzi', en: 'Leftovers', es: 'Sobras' },
  'category.PIATTI_PRONTI.short': { it: 'Avanzi', en: 'Leftovers', es: 'Sobras' },
  'category.DOLCI.label': { it: 'Dolci e snack', en: 'Sweets and snacks', es: 'Dulces y snacks' },
  'category.DOLCI.short': { it: 'Dolci/Snack', en: 'Sweets/Snacks', es: 'Dulces/Snacks' },
  'category.PULIZIA.label': { it: 'Pulizia casa', en: 'House cleaning', es: 'Limpieza del hogar' },
  'category.PULIZIA.short': { it: 'Pulizia casa', en: 'Cleaning', es: 'Limpieza' },
  'category.BUCATO.label': { it: 'Bucato', en: 'Laundry', es: 'Colada' },
  'category.BUCATO.short': { it: 'Bucato', en: 'Laundry', es: 'Colada' },
